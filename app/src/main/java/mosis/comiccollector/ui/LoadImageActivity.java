...
import mosis.comiccollector.util.LoadingScreenManager;
...
//        User user = DepProvider.getUserRepository().getCurrentUser().getValue();
    ...
    private void chooseImage() {
        ...
        LoadingScreenManager.ShowLoadingScreen(this);

        DepProvider.getUserRepository().updateUserProfilePic(this.image_uri, this.picCache,
                (String message) -> {

                    LoadingScreenManager.HideLoadingScreen();

                    Toaster.makeToast(getApplicationContext(), "Profile pic updated");
