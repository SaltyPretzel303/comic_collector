...
public class ProfileActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        this.profile_pic_iv = (ImageView) this.findViewById(R.id.profil_pic_iv);
        this.profile_pic_iv.setOnClickListener(v -> {
...
//        User user = DepProvider.getUserRepository().getCurrentUser().getValue();
        User user = null;

        if (user.hasProfilePic()) {
            this.profile_pic_iv.setImageBitmap(user.getProfPicBitmap());
        }
        // else default pic

        this.username_tv = (TextView) this.findViewById(R.id.profile_username_tv);
        this.username_tv.setText(user.getEmail());
...
//            Bitmap pic = DepProvider.getUserRepository().getCurrentUser().getValue().getProfPicBitmap();
//            this.profile_pic_iv.setImageBitmap(pic);
